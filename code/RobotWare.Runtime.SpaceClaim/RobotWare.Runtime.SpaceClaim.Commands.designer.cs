// ------------------------------------------------------------------------------
//  <auto-generated>
//    Generated by Xsd2Code. Version 3.4.0.20945
...
namespace RobotWare.Runtime.SpaceClaim.Commands {
    ...
    public partial class CommandConfigs {
        
        private List<CommandConfig> commandConfigField;
        
        private static System.Xml.Serialization.XmlSerializer serializer;
        
        public CommandConfigs() {
            this.commandConfigField = new List<CommandConfig>();
        }
        
        public List<CommandConfig> CommandConfig {
            get {
                return this.commandConfigField;
            }
            set {
                this.commandConfigField = value;
            }
        }
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(CommandConfigs));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current CommandConfigs object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an CommandConfigs object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output CommandConfigs object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out CommandConfigs obj, out System.Exception exception) {
            exception = null;
            obj = default(CommandConfigs);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out CommandConfigs obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static CommandConfigs Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((CommandConfigs)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current CommandConfigs object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an CommandConfigs object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output CommandConfigs object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out CommandConfigs obj, out System.Exception exception) {
            exception = null;
            obj = default(CommandConfigs);
            try {
        ...
        public static bool LoadFromFile(string fileName, out CommandConfigs obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static CommandConfigs LoadFromFile(string fileName) {
