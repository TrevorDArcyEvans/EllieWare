...
namespace System.Linq.Expressions.Compiler {
    ...
    internal sealed class HoistedLocals {
        ...
        internal readonly Collections.ObjectModel.ReadOnlyDictionary<Expression, int> Indexes;
        ...
        internal HoistedLocals(HoistedLocals parent, ReadOnlyCollection<ParameterExpression> vars) {
            ...
            Parent = parent;
            Variables = vars;
            Indexes = new Collections.ObjectModel.ReadOnlyDictionary<Expression, int>(indexes);
        }
