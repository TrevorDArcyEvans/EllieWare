  ...
  public partial class MainForm : Form
  {
    ...
    void jobGroupsTreeView_AfterSelect(object sender, TreeViewEventArgs e)
    {
      ...
      if (e.Node is JobNode)
      {
        ...
        var ctrl = new NativeJobDetailDisplay(((JobNode)e.Node).Detail)
                    {
                      Dock = DockStyle.Fill
                    };
      ...
      if (e.Node is TriggerNode)
      {
        ...
        {
          var ctrl = new CronTriggerDisplay((ICronTrigger)((TriggerNode)e.Node).Trigger)
          {
            Dock = DockStyle.Fill
          };
          pnlDetails.Controls.Add(ctrl);
        ...
        {
          var ctrl = new SimpleTriggerDisplay((ISimpleTrigger)((TriggerNode)e.Node).Trigger)
          {
            Dock = DockStyle.Fill
          };
          pnlDetails.Controls.Add(ctrl);
