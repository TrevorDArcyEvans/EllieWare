...
foldersTree = gFld("edtFTPnet/Free", "html/intro.html")
...
aux1 = insFld(foldersTree, gFld("Getting started", "html/productoverview.html"))
  ...
  insDoc(aux1, gLnk("R", "Key Classes", "html/using.html"))
...
aux1 = insFld(foldersTree, gFld("How To...", "html/howto.html"))
  ...
  insDoc(aux1, gLnk("R", "...use FTP events", "html/howtouseftpevents.html"))
