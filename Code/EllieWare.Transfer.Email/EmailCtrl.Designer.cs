...
namespace EllieWare.Transfer.Email
{
  partial class EmailCtrl
  {
    ...
    public Common.ParameterTextBox mRecipients;
    public Common.ParameterTextBox mSubject;
    public Common.ParameterTextBox mAttachments;
    public Common.ParameterTextBox mMessage;
